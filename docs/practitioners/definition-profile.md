...
| Name | Type | Description |
| - | - | - |
| accreditationType | string | The type of accreditation. |
| programCode | string | Required. The program code. |
| program | [Program](#program) | Required. Program information. |
| specialty | [Specialty](#specialty) | Required. Specialty information. |
| programType | string | Required. The program type. |
| trainingStatus | string | Required. The medical professional's training status. |
...
| Name | Type | Description |
| - | - | - |
| type | string | Required. The type of activity. |
...
| addressLines| string[] | Required. A collection of address lines of where the activity has taken, or is taking, place. |
| city | string | Required. The name of the city where the activity has taken, or is taking, place. |
| stateOrProvince | [Region](#region) | Required. The region where the activity has taken, or is taking, place. |
| postalCode | string | The postal code where the activity has taken, or is taking, place. |
| position | string | The medical professional's position during the activity. |
| department | string | The department the medical professional was in during the activity. |
...
| addressType | string | Required. Indicates what the address is for (e.g. Home, Business). |
| lines | string[] | A collection of address lines of the address. |
...
| Name | Type | Description |
| - | - | - |
| ecfmgId | string | Required. The medical professional's ECFMG ID. |
...
| email | string | Required. The medical professional's email address. |
...
| affiliatedInstitution| string | Required. The institution associated with the school. |
| cibisCode | string | Required. The code that CIBIS uses to identify the school. |
...
| Name | Type | Description |
| - | - | - |
| ssnLast4  | string | The last four digits of the medical professional's SSN. |
| npi | string | The National Provider Identifier. |
| usmleId | string | The medical professional's USMLE identification number. |
| birthDate | string (date) | The medical professional's date of birth. |
| birthCity | string | Required. The medical professional's city of birth. |
| birthStateOrProvince | [Region](#region) | Required. The medical professional's state or province of  birth. |
| gender | string | Required. The medical professional's gender. |
...
| degree | [CodedDescription](#codeddescription) | False | The degree. |
...
| firstName| string | Required. The medical professional's first name. |
| middleName | string | The medical professional's middle name. |
| lastName | string | Required. The medical professional's last name. |
| suffix | string | The suffix the medical professional uses. |
...
| Name | Type | Description |
| - | - | - |
| hospitalName | string | Required. The hospital's name. |
| affiliatedInstitution | string | The institution the program is affiliated with. |
| city | string | Required. The city where the hospital is located. |
...
| Name | Type | Description |
| - | - | - |
| description | string | Required. Describes the specialty. |
